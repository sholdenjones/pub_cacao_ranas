...
# extract legend to plot below x-axis, then remove from plot
simpson_legend <- get_legend(plot_extrapolate_simpson)
...
ggsave("output/plot_extrapolate_arrange.png", width = 10, height = 15)
```
