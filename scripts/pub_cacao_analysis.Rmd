...
use dredge to run model selection
```{r}
...
glm_full_shannon <- glm(Shannon_Index ~ veg_scaled + CC_scaled + forest_scaled +
                       water_scaled + elevation_scaled,
                       data = active_data,
...
glm_full_simpson <- glm(Simpson_Index ~ veg_scaled + CC_scaled + forest_scaled +
                       water_scaled + elevation_scaled,
                       data = active_data,
                       family = gaussian)
